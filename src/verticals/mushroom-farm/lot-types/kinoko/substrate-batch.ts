...
export function buildKinokoSubstrateBatch(): SeedLotType {
  return {
    ...
    codePrefix: "SB",
    statuses: [
      { name: "Pasteurizing", color: "#EF4444", category: "unstarted", ordinal: 0 },
      { name: "Cooling", color: "#3B82F6", category: "in_progress", ordinal: 1 },
    ...
    attributes: [
      { attrKey: "substrate_type", dataType: "text", isRequired: true, sortOrder: 0 },
      { attrKey: "weight_lbs", dataType: "number", isRequired: false, unit: "lb", sortOrder: 1 },
    ],
  };
}
