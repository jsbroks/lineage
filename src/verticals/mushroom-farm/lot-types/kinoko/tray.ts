...
export function buildKinokoTray(): SeedLotType {
  return {
    name: "Tray",
    description: "A harvest tray that collects mushrooms from one or more blocks",
    category: "output",
    quantityName: "Weight",
    ...
    attributes: [
      { attrKey: "total_weight_lbs", dataType: "number", isRequired: false, unit: "lb", sortOrder: 0 },
    ],
  };
}
