...
export function buildKinokoSample(): SeedLotType {
  return {
    name: "Sample",
    description:
      "A tissue sample, spore print, or clone for genetic isolation",
    category: "genetics",
    quantityName: "Count",
    ...
    codePrefix: "SA",
    statuses: [
      { name: "Collected", color: "#F59E0B", category: "unstarted", ordinal: 0 },
    ...
    attributes: [
      { attrKey: "source_type", dataType: "text", isRequired: true, sortOrder: 0 },
      { attrKey: "collection_date", dataType: "date", isRequired: true, sortOrder: 1 },
      { attrKey: "source_description", dataType: "text", isRequired: false, sortOrder: 2 },
    ],
  };
}
